    ...
    <div className="fixed inset-0 z-[100]">
      ...
      <div className="absolute right-0 top-0 h-full w-full max-w-[560px] bg-white shadow-xl p-5 overflow-auto">
        ...
        <div className="space-y-6 text-base text-gray-800">
          <section>
            <h4 className="text-lg font-semibold text-gray-900 mb-2">Appendix 8 Explanation</h4>
            <p className="leading-relaxed">{APPENDIX_8}</p>
          </section>

          <section>
            <h4 className="text-lg font-semibold text-gray-900 mb-2">Medal Race Tie-Breaker</h4>
