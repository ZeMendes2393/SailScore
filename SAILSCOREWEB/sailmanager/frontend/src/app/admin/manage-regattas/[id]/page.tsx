...
import NoticeBoard from "../../../regattas/[id]/components/noticeboard/NoticeBoard"; // ✅ IMPORTAÇÃO
  ...
  return (
    <main className="min-h-screen p-8 bg-gray-50">
      ...
      <div className="p-6 bg-white rounded shadow">
        {activeTab === "entry" && <EntryList regattaId={regattaId} admin />}
        {activeTab === "notice" && <NoticeBoard regattaId={regattaId} admin />} {/* ✅ AQUI É A DIFERENÇA */}
        {activeTab === "form" && (
